...
public class ModOreGeneration {
    public static void generateOres(BiomeLoadingEvent event) {for (OreType ore : OreType.values()) {
            ...
            ConfiguredPlacement<TopSolidRangeConfig> configuredPlacement = Placement.RANGE.configure(
                    new TopSolidRangeConfig(ore.getMaxHeight(), ore.getMinHight(), ore.getMaxHeight()));
