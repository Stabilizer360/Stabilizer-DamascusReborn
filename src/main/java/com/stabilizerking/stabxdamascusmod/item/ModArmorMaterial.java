...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    DAMASCUS("damascus",35, new int[]{ 42, 45, 44, 42}, 25,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 9.0f,6f, () -> {
        return Ingredient.fromItems(ModItems.DAMASCUS_INGOT.get());
    });


    private static final int[] MAX_DAMAGE_ARRAY = new int[]{24, 35, 45, 36};
    ...
    public String getName() {
        return StabxDamascusMod.MOD_ID + ":" + this.name;
    }
